...
class JakAndDaxterWorld(World):
    ...
    location_name_groups = {
        ...
        "GR Precursor Orbs": set(Orbs.locGR_orbBundleTable),
        "SV Precursor Orbs": set(Orbs.locSV_orbBundleTable),
        "FJ Precursor Orbs": set(Orbs.locFJ_orbBundleTable),
        "SB Precursor Orbs": set(Orbs.locSB_orbBundleTable),
        "MI Precursor Orbs": set(Orbs.locMI_orbBundleTable),
        "FC Precursor Orbs": set(Orbs.locFC_orbBundleTable),
        "RV Precursor Orbs": set(Orbs.locRV_orbBundleTable),
        "PB Precursor Orbs": set(Orbs.locPB_orbBundleTable),
        "LPC Precursor Orbs": set(Orbs.locLPC_orbBundleTable),
        "BS Precursor Orbs": set(Orbs.locBS_orbBundleTable),
        "MP Precursor Orbs": set(Orbs.locMP_orbBundleTable),
        "VC Precursor Orbs": set(Orbs.locVC_orbBundleTable),
        "SC Precursor Orbs": set(Orbs.locSC_orbBundleTable),
        "SM Precursor Orbs": set(Orbs.locSM_orbBundleTable),
        "LT Precursor Orbs": set(Orbs.locLT_orbBundleTable),
        "GMC Precursor Orbs": set(Orbs.locGMC_orbBundleTable),
